    ...
    <section class="hero">
      <div class="container">
        <div class="hero-content fade-in">
          ...
          <p class="display-4">A comprehensive social platform designed to foster collaboration, knowledge sharing, and
            community engagement within Northeastern University and its surrounding community.</p>
        </div>
      </div>
    </section>
  </div>
