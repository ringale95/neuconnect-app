  ...
  <script type="module" src="${pageContext.request.contextPath}/js/index.js"></script>
     ...
     <style>
            ...
            #filter-submit-form .btn-primary:hover {
                ...
                border-color: black; /* Darker blue color */
            }
        </style>
</head>
<body>
        ...
        <div class="mb-3">
            <form id="filter-submit-form">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="searchKey" placeholder="Search" aria-label="Search" aria-describedby="basic-addon2">
                </div>
                <div class="mb-3">
