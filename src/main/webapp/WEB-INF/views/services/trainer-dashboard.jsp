        ...
        <div class="row">
            ...
            <div class="col-md-3 border" style="padding: 40px; margin-top: 120px; margin-right: 15px;">
                <div class="text-center">
                    <img src="${pageContext.request.contextPath}${user.profilepicPath}" alt="Trainer" class="img-fluid rounded-circle" style="width: 200px;">
            ...
            <div class="col-md-8">
                ...
                <div class="row border" style="padding: 40px; margin-top: 15px;">
                    <div class="col-md-12">
                        ...
                        <div>
                            <button class="btn btn-primary m-2">Start Sessions</button>
                            <button class="btn btn-secondary m-2">Previous Sessions</button>
                        </div>
                    </div>
                </div>
            </div>
