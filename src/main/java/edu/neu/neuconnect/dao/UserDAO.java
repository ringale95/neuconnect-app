...
public class UserDAO extends DAO<User> {
    ...
    public Certificate addCertificateToUser(long id, Certificate certificate) throws Exception {
        try {
            begin();
    ...
    public Certificate getCertificateById(long cert_id) throws Exception {
        try {
            begin();
            Certificate certificate = getSession().get(Certificate.class, cert_id);
            commit();
            close();
            return certificate;
        } catch (HibernateException e) {
