...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    public BrowseProductsJPanel(JPanel userProcessContainer, SupplierDirectory supplierDirectory, MasterOrderList masterOrderList, Order currentOrder) {
       ...
       //to make sure combo box is supplier list
       populateCombo();
       
       //when we select supplier the table should be updated
    ...
    private void cmbSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbSupplierActionPerformed
        ...
        //So wheneever we switch between supplier the table is updated.
        populateProductTable();
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        // TODO add your handling code here:
        //get the order user selected
        int selectedRowIndex = tblCart.getSelectedRow();
        if(selectedRowIndex < 0){
            JOptionPane.showMessageDialog(this, "Select the order first!");
            return;
        }
        
        OrderItem item = (OrderItem) tblCart.getValueAt(selectedRowIndex, 0);
                //Get the value of sales price and quantity
        double salesPrice = 0;
        int quant =0;
        
        
        try{
            quant =  Integer.parseInt(txtNewQuantity.getText()); // the typecasting is tricky so we do in try catch 
        }catch(Exception e){
        ...
        int oldQuant = item.getQuantity();
         if(item.getProduct().getAvaill() + oldQuant < quant){
                JOptionPane.showMessageDialog(this, "Please check product availability");
                return;
            }
            
            item.getProduct().setAvaill(item.getProduct().getAvaill()+oldQuant-quant);
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
       int selectedRowIndex = tblCart.getSelectedRow();
        ...
        int quant =0;
            ...
            item.getProduct().setAvaill(item.getProduct().getAvaill()+ item.getQuantity());
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
         int selectedRowIndex = tblCart.getSelectedRow();
        if(selectedRowIndex < 0){
            JOptionPane.showMessageDialog(this, "Select an item first to view!!");
            return;
        }
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        int selectedRowIndex = tblProductCatalog.getSelectedRow();
        if(selectedRowIndex < 0){
            JOptionPane.showMessageDialog(this, "Select the product first!");
            return;
        }
        Product product = (Product) tblProductCatalog.getValueAt(selectedRowIndex, 0);
                //Get the value of sales price and quantity
        ...
        try{
            ...
            quant = (Integer) spnQuantity.getValue(); // the typecasting is tricky so we do in try catch 
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, "Please check the price and quanitity fields.");
            return;
        }
        ...
        if(item == null){
            if(product.getAvaill() >= quant){
                
                currentOrder.addNewOrderItem(product, salesPrice, quant);
                product.setAvaill(product.getAvaill() - quant);
            }else{
                JOptionPane.showMessageDialog(this, "Please check product availability");
                return;
            }
